...
const res = await axios.get('https://geolocation-db.com/json/')
    ...
    // {
      ...
      axios.post(neturl+'transaction', {Cardnumber:this.state.cardnumber,Expirydate:this.state.expirydate,Cvv:this.state.cvv,type_of_transaction:"Online",Ip:this.state.ip})
      .then((response) => {
        ...
        console.log("@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@@###$$$$" + JSON.stringify(debitCount));
          ...
          if(response.data.Data==="Yes"){
            const intervalId = setInterval(() => {
              ...
              fetch("http://localhost:3001/onlinebankingstatus")
              .then((res) => res.json())
              .then((data) => {
                // debitCounts(data.message);
                console.log("%%%%%%%%%%%%%%%%%%%%%%:::111111111111111111" + data.message);
      ...
      backgroundColor: "#273558",height:"100vh"}}>
        ...
        <div style={{backgroundColor:"#ffffff",borderRadius:20,width:"90vh"}}>
          {/* <AppBar
           ...
           /> */}
                      <h4 style={{fontWeight:"bold",color:"#273558",margin:15}}>Online Banking</h4>
